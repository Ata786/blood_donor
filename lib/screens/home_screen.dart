...
import 'package:blood_bank/model/Check_connection.dart';
...
class _HomeScreenState extends State<HomeScreen> {
                                      ...
                                      if(snapshot.hasData){
                                        return Column(
                                          ...
                                          children: [
                                            Text(
                                              '${snapshot.data!.name}',
                                              style: TextStyle(color: Colors.white,fontSize: myWidth / 20),),
                                            Row(children: [
                                              ...
                                              FutureBuilder<Placemark>(
                                                ...
                                                builder: (context,snapshot){
                                                  if(snapshot.hasData){
                                                    return Text(
                                                      '${snapshot.data!.locality}',style: TextStyle(color: Colors.white,fontSize: myWidth / 35),);
                                                  }else{
                                                  ...
                                                  children: [
                                                    ...
                                                    FutureBuilder<User>(
                                                      ...
                                                      builder: (context,snapshot){
                                                        if(snapshot.hasData){
                                                          return Text(
                                                            '${snapshot.data!.bloodGroup}',style: TextStyle(color: Color(CustomColors.PRIMARY_COLOR)),);
                                                        }else{
  ...
  showDialogBox(double myHeight,double myWidth){
    showDialog(context: context, builder: (context){
      return AlertDialog(content: CustomDialog(myHeight, myWidth).internetDialog(),);
    });
  }
